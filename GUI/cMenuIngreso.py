...
from Files_from_thinker_designer.build import Rojo
...
def open_window_Rojo():
    return Rojo.VentanaRoja()

def MenuIngresoPacientes():
    window = Tk()
    ...
    #Este sería el contenedor de listas
